...
const cemento_1 = require("@MasterVentures/cemento");
const Web3Signer_1 = require("./Web3Signer");
const cemento_2 = require("@MasterVentures/cemento");
class Web3Plugin extends cemento_2.CementoProvider {
    getProviderType() {
        return cemento_1.CementoProviderType.Web3;
    }
    onReady(settings) {
